...
<!-- <div class="inside_space colored spaced">notities<a href="checkups">view</a></div> -->
<?php if($this->auth->hasAnyRole(\Delight\Auth\Role::ADMIN)): ?>
    ...
    <div class="inside_space colored spaced">cipiersaanvragen<a href="cipierrequests">view</a></div>
<?php endif; ?>